...
const (
	Object_CreateObject_FullMethodName = "/api.object.v1.Object/CreateObject"
	Object_UpdateObject_FullMethodName = "/api.object.v1.Object/UpdateObject"
	Object_DeleteObject_FullMethodName = "/api.object.v1.Object/DeleteObject"
	Object_GetObject_FullMethodName    = "/api.object.v1.Object/GetObject"
	Object_ListObject_FullMethodName   = "/api.object.v1.Object/ListObject"
)
...
func (c *objectClient) CreateObject(ctx context.Context, in *CreateObjectRequest, opts ...grpc.CallOption) (*CreateObjectReply, error) {
	...
	err := c.cc.Invoke(ctx, Object_CreateObject_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *objectClient) UpdateObject(ctx context.Context, in *UpdateObjectRequest, opts ...grpc.CallOption) (*UpdateObjectReply, error) {
	...
	err := c.cc.Invoke(ctx, Object_UpdateObject_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *objectClient) ListObject(ctx context.Context, in *ListObjectRequest, opts ...grpc.CallOption) (*ListObjectReply, error) {
	...
	err := c.cc.Invoke(ctx, Object_ListObject_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Object_UpdateObject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Object_UpdateObject_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Object_ListObject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Object_ListObject_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Object_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/object/v1/object.proto",
}
